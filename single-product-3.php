<?php
/*
Template Name: Product Post Layout 3
  ...
  <main>
      ...
      <div class="section-inner">
        <div class="assay-development-heading">
          <div class="section-head">
            ...
            <h2>A structured path to technical feasibility.</h2>
          </div>
          <p>The documented proof-of-concept program focuses on designing and validating primer sets for 11 bacterial
            pathogens commonly implicated in human infection.</p>
        </div>
    ...
    <section class="assay-roadmap">
      <div class="section-inner assay-roadmap-grid">
        <div class="assay-roadmap-copy">
          <p class="eyebrow">Where the panel is going</p>
          <h2>Toward a broader, more comprehensive sepsis diagnostic.</h2>
          <p>Beyond the initial bacterial targets, Delphine plans to expand the panel to include antimicrobial
            resistance markers and additional pathogen classes.</p>
        </div>
    ...
    <section class="assay-partner">
      <div class="section-inner assay-partner-box">
        <div>
          <p class="eyebrow">Clinical and laboratory collaboration</p>
          <h2>Help shape the assay around real user needs.</h2>
          <p>Delphine is seeking input from future customers and partners on priority targets, nucleic-acid extraction
